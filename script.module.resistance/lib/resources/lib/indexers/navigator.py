...
class navigator:
    def root(self):
    	self.addDirectoryItem('[COLOR yellow][I]WELCOME TO THE RESISTANCE[/I][/COLOR]', '', 'icon.png', 'DefaultMovies.png')
    	self.addDirectoryItem('[COLOR pearl][I]--------------------------------------------------[/I][/COLOR]', '', 'icon.png', 'DefaultMovies.png')
    ...
    def movies(self, lite=False):
    	self.addDirectoryItem('[COLOR yellow][I]RESISTANCE MOVIE SECTION[/I][/COLOR]', '', 'icon.png', 'DefaultMovies.png')
    	self.addDirectoryItem('[COLOR pearl][I]--------------------------------------------------[/I][/COLOR]', '', 'icon.png', 'DefaultMovies.png')
        ...
        if lite == False:
            if not control.setting('lists.widget') == '0':
                self.addDirectoryItem(32003, 'mymovieliteNavigator', '2.png', 'DefaultVideoPlaylists.png')

            self.addDirectoryItem(32028, 'moviePerson', '2.png', 'DefaultMovies.png')
            self.addDirectoryItem(32010, 'movieSearch', '2.png', 'DefaultMovies.png')
    ...
    def tvshows(self, lite=False):
    	self.addDirectoryItem('[COLOR yellow][I]RESISTANCE TV SHOWS SECTION[/I][/COLOR]', '', 'icon.png', 'DefaultMovies.png')
    	self.addDirectoryItem('[COLOR pearl][I]--------------------------------------------------[/I][/COLOR]', '', 'icon.png', 'DefaultMovies.png')
        ...
        if lite == False:
            if not control.setting('lists.widget') == '0':
                self.addDirectoryItem(32004, 'mytvliteNavigator', '3.png', 'DefaultVideoPlaylists.png')

            self.addDirectoryItem(32028, 'tvPerson', '3.png', 'DefaultTVShows.png')
            self.addDirectoryItem(32010, 'tvSearch', '3.png', 'DefaultTVShows.png')
    ...
    def paranormal(self, lite=False):
        ...
        self.addDirectoryItem('paranormal scarecrow', 'tvshows&url=paral', 'p.png', 'DefaultTVShows.png')
