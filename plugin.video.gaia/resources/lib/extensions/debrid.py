...
class Premiumize(Debrid):
	...
	def _retrieve(self, action, category = None, id = None, parent = None, name = None, items = None, type = None, source = None, hash = None, link = None, itemId = None, itemType = None, httpTimeout = None, httpData = None, httpHeaders = None):
		if category == None:
			return self._retrieveOld(action = action, link = link, httpTimeout = httpTimeout, httpData = httpData, httpHeaders = httpHeaders)
		else:
			return self._retrieveNew(category = category, action = action, id = id, parent = parent, name = name, items = items, type = type, source = source, hash = hash, itemId = itemId, itemType = itemType, httpTimeout = httpTimeout, httpData = httpData, httpHeaders = httpHeaders)
	...
	def _retrieveNew(self, category, action, id = None, parent = None, name = None, items = None, type = None, source = None, hash = None, itemId = None, itemType = None, httpTimeout = None, httpData = None, httpHeaders = None):
		link = self._linkNew()
	...
	def _addLink(self, result = None, id = None, season = None, episode = None):
		...
		if result and 'result' in result and 'location' in result['result'] and network.Networker.linkIs(result['result']['location']):
			...
			except: error = self.ErrorPremiumize
	...
	def addContainer(self, link, title = None, season = None, episode = None):
		try:
			...
			except: return self.addResult(error = self.ErrorPremiumize)
		except:
			tools.Logger.error()
			return self.addResult(error = self.ErrorPremiumize)
	...
	def addHoster(self, link, season = None, episode = None):
		...
		else: return self.addResult(error = self.ErrorPremiumize)
	...
	def cached(self, id, timeout = None, callback = None, sources = None):
		...
		def cachedChunk(callback, hashes, timeout):
			premiumize = Premiumize()
			result = premiumize._retrieve(category = self.CategoryTorrent, action = self.ActionCheck, hash = hashes, httpTimeout = timeout)
		...
		threads = []
		for chunk in chunks:
			thread = threading.Thread(target = cachedChunk, args = (callback, chunk, timeout))
...
class OffCloud(Debrid):
	...
	def add(self, link, category = None, title = None, season = None, episode = None, source = None, proxy = None):
		...
		if type == network.Container.TypeTorrent:
			...
			return self.addHoster(link = link, category = category, season = season, episode = episode)
