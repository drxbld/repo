...
class source:
    def __init__(self):
    	...
    	self.enabled = control.setting('accounts.providers.gostream.enabled') == 'true'
    	self.user = control.setting('accounts.providers.gostream.user')
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            if (not self.enabled or self.user == '' or self.password == ''):
            # [/GAIACODE]
