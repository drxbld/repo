...
class source:
	...
	def sources(self, url, hostDict, hostprDict):
		try:
			...
			# [GAIACODE]
			# Do not mark Torba links as direct, since they require a webbrowser validation.
			...
			for i in links: sources.append({'source': 'torba.se', 'quality': i['quality'], 'language': 'en', 'url': i['url'], 'direct': False, 'debridonly': False, 'autoplay': False})
			# [/GAIACODE]
	...
	def resolve(self, url, internal = False):
	# [/GAIACODE]
		try:
			m3u8 = [
				'#EXTM3U',
